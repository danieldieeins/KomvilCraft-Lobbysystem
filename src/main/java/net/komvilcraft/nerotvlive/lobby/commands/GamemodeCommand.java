    ...
    public boolean onCommand(@NotNull CommandSender s, @NotNull Command cmd, @NotNull String label, String[] args) {
        if(cmd.getName().equalsIgnoreCase("GameMode")) {
            if(s instanceof Player p) {
                ...
                if(p.hasPermission("komvilcraft.lobby.commands.gamemode")) {
                    if (args.length == 0) {
                        ...
                        if(args[0].equalsIgnoreCase("0")||args[0].equalsIgnoreCase("survival")) {
                            if(args.length == 1) {
                                ...
                                if(Bukkit.getPlayer(args[1])!=null) {
                                    LobbyUser t = LobbyAPI.getLobbyUser(Bukkit.getPlayer(args[1]).getUniqueId());
                ...
                if (s.hasPermission("komvilcraft.lobby.commands.gamemode")) {
                    if (args.length == 2) {
                        if (Bukkit.getPlayer(args[1]) != null) {
                            LobbyUser t = LobbyAPI.getLobbyUser(Bukkit.getPlayer(args[1]).getUniqueId());
                            if (args[0].equalsIgnoreCase("0") || args[0].equalsIgnoreCase("survival")) {
